...
window.Modernizr = (function( window, document, undefined ) {
    ...
    // Also in iOS5  Browsing mode, attempting to use localStorage.setItem
    ...
    /**
     * addTest allows the UserInfo to define their own feature tests
    ...
    // Assign  properties to the return object with prefix
